...
public class EventosResources {
	...
	public ResponseEntity<Void> salvar(
			@ApiParam(name = "Adicionar uma casa.", value = "Adicionar uma casa a lista") @Valid @RequestBody Evento evento) {
		evento = eventoServ.salvar(evento);
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{codigo}").buildAndExpand(evento.getId())
				.toUri();
	...
	public ResponseEntity<Evento> buscar(
			@ApiParam(value = "Buscar um evento", example = "1") @PathVariable("codigo") Long codigo) {
	...
	public ResponseEntity<Void> deletar(
			@ApiParam(name = "Deletar um evento.", value = "Deletar um evento da lista.") @PathVariable("codigo") Long codigo) {
	...
	public ResponseEntity<Void> atualizar(
			@ApiParam(name = "Atualizar um evento.", value = "Atualizar dados de um evento.", example = "1") @RequestBody Evento evento,
